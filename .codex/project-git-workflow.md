...
<!-- initialized-at: 2026-06-11 19:41:28 +08:00 -->

# Codex Git Workflow

Initialization status: initialized
Project: Lumina
Repository root: D:/WebProjects/Lumina
Machine config: `
...
```
powershell
git -c safe.directory=D:/WebProjects/Lumina status --short --branch
```
...
```
powershell
git -c safe.directory=D:/WebProjects/Lumina push -u origin HEAD
```
